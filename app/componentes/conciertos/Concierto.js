...
export default function Concierto({fecha, lugar, hora, cartel}) {
  ...
  return (
    <>
      <div className="bg-gray-200/20 border rounded-lg grid grid-cols-10 mb-8 hover:border-[#8b5504] duration-300 hover:cursor-pointer group" onClick={() => {if (window.innerWidth >= 1024 && cartel) { setCartelAbierto(true); }}}>
