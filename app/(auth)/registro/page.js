      ...
      <div className="w-[40vw] h-[70vh] bg-white/5 backdrop-blur rounded-3xl border border-white/30">
        <form className="px-16 py-8 h-full flex flex-col justify-around" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input className="border border-white/30 rounded w-full p-2 text-white" id="correo" type="text" placeholder="Escriba su correo electrónico"/>
          </div>

          <div>
            <label className="block text-white/90 font-bold mb-2" htmlFor="usuario">Nombre de usuario</label>
            <input className="border border-white/30 rounded w-full p-2 text-white" id="usuario" type="text" placeholder="Escriba su nombre de usuario"/>
          </div>

          <div>
            <label className="block text-white/90 font-bold mb-2" htmlFor="passwd">Contraseña</label>
            <input className="border border-white/30 rounded w-full p-2 text-white" id="passwd" type="password" placeholder="Escriba su contraseña"/>
          </div>

          <div>
            <label className="block text-white/90 font-bold mb-2" htmlFor="passwd">Verificar contraseña</label>
            <input className="border border-white/30 rounded w-full p-2 text-white" id="passwd" type="password" placeholder="Repita su contraseña"/>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <Link href="/login" className="hover:underline text-sm flex justify-end mt-4">Si ya tienes una cuenta, puedes iniciar sesión aquí</Link>
