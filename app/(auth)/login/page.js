        ...
        */}
        ...
        <form className="px-8 lg:px-16 py-8 h-full flex flex-col justify-around text-sm lg:text-lg" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input className="border border-white/30 rounded w-full p-2 text-white text-sm" id="password" type="password" value={password} onChange={(event) => setPassword(event.target.value)} required placeholder="******************"/>
          </div>
